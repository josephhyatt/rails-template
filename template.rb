require "fileutils" # Several file utility methods for copying, moving, removing, etc
require "shellwords" # Ruby standard library shellwords
...
def add_template_repository_to_source_path
  if __FILE__ =~ %r{\Ahttps?://}
    ...
    git clone: [
      "--quiet",
      "https://github.com/josephhyatt/rails-template.git",
      tempdir
...
def add_gems
  gem 'administrate', '~> 0.11.0' # Provides a better user experience for site admins, and to be easier for developers to customize
  ...
  gem 'bootstrap', '~> 4.3', '>= 4.3.1' # The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web
  gem 'devise', '~> 4.6', '>= 4.6.2' # Flexible authentication solution for Rails with Warden
  gem 'devise-bootstrapped', github: 'excid3/devise-bootstrapped', branch: 'bootstrap4'
  gem 'devise_masquerade', '~> 0.6.2' # Devise masquerade library
  gem 'font-awesome-sass', '~> 5.8', '>= 5.8.1' # Font-Awesome SASS gem for use in Ruby projects
  gem 'friendly_id', '~> 5.2', '>= 5.2.5' # Lets you create pretty URLs and work with human-friendly strings as if they were numeric ids
  gem 'gravatar_image_tag', github: 'mdeering/gravatar_image_tag'
  gem 'mini_magick', '~> 4.9', '>= 4.9.3' # Manipulate images with minimal use of memory via ImageMagick / GraphicsMagick
  gem 'name_of_person', '~> 1.1', '>= 1.1.1' # Presenting names of people in full, familiar, abbreviated, and initialized forms (but without titulation etc)
  gem 'omniauth-facebook', '~> 5.0' # Facebook OAuth2 Strategy for OmniAuth
  gem 'omniauth-github', '~> 1.3' # Official OmniAuth strategy for GitHub
  gem 'omniauth-twitter', '~> 1.4' # OmniAuth strategy for Twitter
  gem 'sidekiq', '~> 5.2', '>= 5.2.7' # Simple, efficient background processing for Ruby
  gem 'sitemap_generator', '~> 6.0', '>= 6.0.2' # Video, News, Image, Mobile, PageMap and Alternate Links sitemap extensions and includes Rake tasks for managing your sitemaps
...
after_bundle do
  ...
  say "on server: http://localhost:5000/"
end